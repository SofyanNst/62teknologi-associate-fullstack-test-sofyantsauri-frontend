            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr />
                        <div class="container">
                            <router-link :to="{ name: 'addrestaurant' }" class="btn btn-success"><svg
                                    ...
                                    <tr v-for="(restaurant, index) in restaurants" :key="index">
                                        ...
                                        <td>
                                            <router-link :to="{ name: 'editrestaurant', params: { id: restaurant.id } }"
                                                class="btn btn-warning mx-1"><svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <button @click.prevent="restaurantDelete(restaurant.id)"
                                                class="btn btn-danger mx-1"><svg xmlns="http://www.w3.org/2000/svg"
